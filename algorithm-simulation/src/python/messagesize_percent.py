...
# Compute percentage difference relative to alg1, centered at zero
diff_percent = [((c2 - c1) / c1) * 100 for c1, c2 in zip(cost1, cost2)]

# Plot
plt.figure(figsize=(10, 6))
plt.plot(message_sizes, diff_percent, marker='o', color='blue',
         label=f"{alg2['name']} vs {alg1['name']} (%)")
